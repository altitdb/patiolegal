...
public class ReportUtils {
	...
	public InputStream generateSealReport(SealRequestDTO request, ProtocolDTO protocolDTO) {
		...
		sealDto.setProtocol(protocolDTO.getProtocol());
		sealDto.setAuthentication(protocolDTO.getAuthentication());
