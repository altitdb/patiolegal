...
public class ProtocolServiceBean implements ProtocolService {
	...
	public InputStream generate(ProtocolRequestDTO request) {
		...
		if (protocol.isPresent()) {
			...
			ProtocolDTO dto = new ProtocolDTOBuilder().withPart(protocolValue.getPart())
					.withProtocol(protocolValue.getProtocol()).withDate(protocolValue.getDate())
					...
					.withEventBulletin(protocolValue.getEventBulletin()).withTaxId(protocolValue.getTaxId())
					.withName(protocolValue.getName()).withTheyRenamed(vehicle.getTheyRenamed())
					...
					.withOriginalPlate(vehicle.getOriginalPlate()).withOriginCapture(protocolValue.getOriginCapture())
					...
					.withAccountableIn(protocolValue.getAccountableIn()).withBoard(protocolValue.getBoard())
					.withAuthentication(protocolValue.getAuthentication())
					.withAmountSeals(protocolValue.getAmountSeals()).build();
