	...
	public InputStream generate(ProtocolRequestDTO request) {
		...
		if(protocol.isPresent()){
            ...
            ProtocolDTO dto = new ProtocolDTOBuilder()
										...
										.withMotorState(protocolValue.getEntrance().getVehicle().getMotorState())
										.withMotor(protocolValue.getEntrance().getVehicle().getMotor())
										.withInsured(protocolValue.getEntrance().getPoliceData().getInsured())
										.withFinanced(protocolValue.getEntrance().getPoliceData().getFinanced())
										.withStolen(protocolValue.getEntrance().getPoliceData().getStolen())
										.withDrugTrafficking(protocolValue.getEntrance().getPoliceData().getDrugTrafficking())
										.withMoneyLaundry(protocolValue.getEntrance().getPoliceData().getMoneyLaundry())
										.withPerquisite(protocolValue.getEntrance().getPoliceData().getPerquisite())
										.withPapillaryExpertise(protocolValue.getEntrance().getPoliceData().getPapillaryExpertise())
										.withOwnerIntimate(protocolValue.getEntrance().getPoliceData().getOwnerIntimate())
										.withAuthorizedAlienation(protocolValue.getEntrance().getPoliceData().getAuthorizedAlienation())
										.withDebits(protocolValue.getEntrance().getPoliceData().getDebits())
										.withShed(protocolValue.getEntrance().getShedData().getShed())
										.withRow(protocolValue.getEntrance().getShedData().getRow())
										.withColumn(protocolValue.getEntrance().getShedData().getColumn())
										.withFloor(protocolValue.getEntrance().getShedData().getFloor())
