...
var LoginService = /** @class */ (function () {
    function LoginService(_httpCliente, _router) {
        ...
        this._router = _router;
        this.url = window.location.origin + "/api/v1/login";
    }
    LoginService.prototype.login = function (data) {
        var ACCESS_DATA = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set('username', data.user)
            .append('password', data.password);
        var HEADERS = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json');
        return this._httpCliente.post(this.url, ACCESS_DATA.toString(), {
            headers: HEADERS
        });
    };
...
/* harmony import */ var _entrance_entrance_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./entrance/entrance.component */ "./src/app/main/entrance/entrance.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild([
                    {
                        ...
                        children: [
                            {
                                path: 'entrance',
                                component: _entrance_entrance_component__WEBPACK_IMPORTED_MODULE_4__["EntranceComponent"]
                            },
                            {
                                path: 'exit',
...
module.exports = __webpack_require__(/*! D:\work\patiolegal\src\main\angular\src\main.ts */"./src/main.ts");
