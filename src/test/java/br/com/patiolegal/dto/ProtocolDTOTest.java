...
public class ProtocolDTOTest {
	...
	@Test
	public void shouldBuilderWithOriginCapture() {
		String originCapture = "Origem";

		ProtocolDTO dto = new ProtocolDTOBuilder().withOriginCapture(originCapture).build();

		Assert.assertEquals(dto.getOriginCapture(), originCapture);
	}
